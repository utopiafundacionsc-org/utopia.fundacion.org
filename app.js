...
(() => {
  ...
  const BUILD_VERSION = "12.5.6-20260717";
  ...
  function syncFormAvailability() {
    ...
    const canSubmit = canShowPayment && hasParticipantValues() && proofReady && Boolean(state.reservation || state.hold) && !state.isReserving;

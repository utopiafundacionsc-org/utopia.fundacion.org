  ...
  (()=>{
    ...
    const BUILD_VERSION="12.3.9-20260716";
    ...
    function setup(){
      ...
      bind("#liveRaffleSelect","change",e=>{state.liveRaffleId=e.target.value;state.liveSession=null;state.liveCurrentWinner=null;state.liveBackgroundDraft=null;state.liveBurnedAll=[];state.liveBurned=[];qs('#liveBackgroundReady').hidden=true;qs('#liveApplyBackground').disabled=true;stopLiveAnimation();loadLiveDraw()});
